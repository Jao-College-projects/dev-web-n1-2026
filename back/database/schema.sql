...
INSERT INTO public.secoes_home (identificador, titulo_secao, ordem, conteudo) VALUES
    ('hero', 'Hero Principal', 1, '{"kicker": "Boutique · São Paulo", "titulo_linha1": "Luar", "titulo_linha2": "Móveis", "tagline": "A quiet expression of timeless living.", "descricao": "Curadoria boutique de móveis para ambientes clássicos, elegantes e atemporais.", "cta_1_texto": "Explorar coleção", "cta_2_texto": "Ver ambientes", "imagem_url": "/assets/placeholder-hero.webp"}'),
    ('manifesto', 'Manifesto da Marca', 2, '{"titulo": "Design Autoral", "texto": "Cada peça é pensada..."}')
